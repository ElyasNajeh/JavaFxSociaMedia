...
public class SaveUsersDesc implements Comparator <User> {
	...
	public void Display() {
		File file = new File("C:\\Users\\HP\\eclipse-workspace\\FxSocial\\Users Descending.txt");
		try (PrintWriter writer = new PrintWriter(new FileWriter(file))) {
			...
			a.InfoAlert("Success", "User data Descending saved successfully!");
		} catch (IOException e) {
			a.ErrorAlert("Error", "Failed to save Users data Descending");
		}
	}
